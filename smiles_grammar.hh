...
/**
 ** \file smiles_grammar.hh
 ** Define the smiles_parser::parser class.
 */
...
switch (yykind)
    {
      ...
      {
        return SmilesTokenParser::symbol_name (this->kind ());
      }
#endif // #if YYDEBUG || 0
...
#if 201103L <= YY_CPLUSPLUS
    /// Non copyable.
    SmilesTokenParser (const SmilesTokenParser&) = delete;
    /// Non copyable.
    SmilesTokenParser& operator= (const SmilesTokenParser&) = delete;
#endif
...
#if YY_CPLUSPLUS < 201103L
    /// Non copyable.
    SmilesTokenParser (const SmilesTokenParser&);
    /// Non copyable.
    SmilesTokenParser& operator= (const SmilesTokenParser&);
#endif
...
#endif // !YY_YY_SMILES_GRAMMAR_HH_INCLUDED
