...
#line 643 "smiles_grammar.cc"
  ...
  {
      -3,    -8,    -8,   108,     6,    -3,    66,    -8,   112,    -8,
      -8,     2,    -8,     5,    30,    -2,    29,    -1,    -8,    -3,
      66,    -8,    85,    -7,    -8,    -8,    -8,    -8,    -8,     0,
      21,    -8,    10,    86,    -8,    -8,    -8,    -8,    35,    -8,
      14,    40,    -8,    43,    -8,     4,     1,    28,    52,    70,
      72,    59,    -3,    18,    -3,    -8,    -8,    -8,    -8,    74,
      -8,    -8,    92,    -8,    -8,    32,    -8,    -8,    -8,    -8,
      -8,    -8,    -8,    -8,    -8,    -8,    46,    98,    -8,    -8,
      -8,    77,    -8
  };
  ...
  {
      34,    20,     1,    50,    68,     2,    18,    66,    42,    41,
      45,    55,    56,    58,    34,    19,    67,    63,    53,     3,
      59,    21,    46,     1,    51,    69,     2,    60,    22,    75,
      23,    24,    25,    26,    27,    28,    49,    29,    30,    31,
       3,    57,    62,    64,    32,    43,    65,    34,    20,    21,
      76,     1,    70,    44,     2,    79,    22,    80,    23,    24,
      25,    26,    27,    28,    71,    29,    30,    31,     3,    21,
      34,     1,    32,    72,     2,    73,    22,    77,    23,    24,
      25,    26,    27,    28,    74,    29,    30,    31,     3,    21,
       1,     1,    32,     2,     2,    78,    61,    23,    24,    25,
      26,    27,    28,    82,    29,    30,    31,     3,     3,    81,
      52,     8,    32,     9,    10,    11,    12,    36,    37,    38,
      39,    54,    13,     0,     0,     0,    40
  };
  ...
  {
       6,     5,     5,     4,     3,     8,     0,     3,     3,     7,
      12,    18,    12,     3,    20,     9,    12,     3,    22,    22,
      10,     3,    24,     5,    25,    24,     8,    33,    10,    11,
      12,    13,    14,    15,    16,    17,     7,    19,    20,    21,
      22,    20,     7,     3,    26,    15,     3,    53,    52,     3,
      54,     5,    24,    23,     8,    23,    10,    11,    12,    13,
      14,    15,    16,    17,    12,    19,    20,    21,    22,     3,
      76,     5,    26,     3,     8,     3,    10,     3,    12,    13,
      14,    15,    16,    17,    25,    19,    20,    21,    22,     3,
       5,     5,    26,     8,     8,     3,    33,    12,    13,    14,
      15,    16,    17,    26,    19,    20,    21,    22,    22,    11,
      19,     3,    26,     5,     6,     7,     8,     5,     6,     7,
       8,    22,    14,    -1,    -1,    -1,    14
  };
  ...
  {
       0,     5,     8,    22,    28,    29,    30,    32,     3,     5,
       6,     7,     8,    14,    33,    36,    37,    38,     0,     9,
      30,     3,    10,    12,    13,    14,    15,    16,    17,    19,
      20,    21,    26,    31,    32,    39,     5,     6,     7,     8,
      14,     7,     3,    15,    23,    12,    24,    34,    35,     7,
       4,    25,    29,    30,    31,    18,    12,    20,     3,    10,
      32,    39,     7,     3,     3,     3,     3,    12,     3,    24,
      24,    12,     3,     3,    25,    11,    30,     3,     3,    23,
      11,    11,    26
  };
  ...
  "')'", "'-'", "'='", "'#'", "':'", "'$'", "'~'", "'>'", "'<'", "'\\\\'",
  "'/'", "'['", "']'", "'+'", "'@'", "'%'", "$accept", "mols", "mol",
  "seq", "bond", "atom", "charge_element", "plus_signs", "minus_signs",
  "h_element", "chiral_element", "element", "ring_number", YY_NULLPTR
  };
#endif
